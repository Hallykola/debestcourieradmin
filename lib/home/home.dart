              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    const Greeting(),
                    Wrap(
                        children:const [ Counter(number: '45', item: 'Users'),
    ...
    return SingleChildScrollView(
        ...
        child: Row(
          children: const [
            ...
            LinkTab(
                title: 'List of Users', icon: 'assets/icons/delivery-bike.svg'),
            LinkTab(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                offset: Offset(2, 4), color: Colors.amberAccent, blurRadius: 2)
          ]),
      child: Row(
        children: [
          SvgPicture.asset(
